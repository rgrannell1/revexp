...
export declare const parts: {
    ...
    nonLineBreak: () => () => string;
    and: (ths: import("./core/commons/types.js").StringThunk[]) => () => string;
    or: (ths: import("./core/commons/types.js").StringThunk[]) => import("./core/commons/types.js").StringThunk;
    repeat: (th: import("./core/commons/types.js").StringThunk, opts: import("./core/quantifiers.js").RepeatOpts) => () => string;
};
